...
parser.add_option("-p", "--path", dest="train_path", help="Path to training data.", default = 'imgs')
...
parser.add_option("--epoch_length", type = "int", dest="epoch_length", help="Length of Epoch", default=500)
...
with open('log.txt','w') as f:
	f.write('curr_loss\t best_loss\t mean_acc \n')
		...
		try:
			...
			if iter_num == epoch_length:
				...
				if class_acc > best_acc:
					model_all.save_weights('model_frcnn_best_acc.hdf5')
					best_acc = class_acc
				...
				with open('log.txt', 'a') as f:
					f.write('{}\t{}\t{}\n'.format(curr_loss, best_loss, class_acc))
